/**
 * FixitGrid plumbing — hard isolation child config.
 */
const HARD_SITE_URL = "https://fixitgrid-plumbing.pages.dev";
const HARD_CANONICAL_ORIGIN = "https://fixitgrid.com";
const HARD_NICHE_LABEL = "Plumbing";
const HARD_PHONE_E164 = "+19545550100";
const HARD_PHONE_DISPLAY = "+1 (954) 555-0100";
